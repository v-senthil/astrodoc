...
sidebar:
  order: 2
description: Broadcast supports both custom message for each end user or same
  message for all end users. You can use it as per your use case in your
  product.
slug: 1.0.0/broadcasts/add-a-broadcast
---
