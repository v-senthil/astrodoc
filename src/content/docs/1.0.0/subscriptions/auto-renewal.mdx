...
sidebar:
  order: 1
description: IM Credits add-on auto renewal can be configured only for portals
  with an active payment source available.
slug: 1.0.0/subscriptions/auto-renewal
---
