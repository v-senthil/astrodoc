...
sidebar:
  order: 4
description: WhatsApp Flows is a way to build structured interactions for
  business messaging. With Flows, businesses can define, configure, and
  customize messages with rich interactions that give customers more structure
  in the way they communicate. You…
slug: 1.0.0/whatsapp-custom-apis/whatsapp-flows-api
---
...
![Illustration](/astrodoc/inline-images/whatsapp-custom-apis/whatsapp-flows-api/1.0.0/1750818213948.png)
...
<table><colgroup><col /> <col /></colgroup><tbody><tr><td><div><p>Error Code</p></div></td><td><div><p>Description</p></div></td></tr><tr><td><div><p>UNKNOWN\_ERROR</p></div></td><td><div><p>Unknown error from WhatsApp</p></div></td></tr><tr><td><div><p>UNIQUE\_NAME</p></div></td><td><div><p>Flow name is not unique</p></div></td></tr><tr><td><div><p>PUBLISH\_FAILED</p></div></td><td><div><p>Flow was created, but publishing failed</p></div></td></tr><tr><td><div><p>CANNOT\_DELETE</p></div></td><td><div><p>Delete published flow</p></div></td></tr></tbody></table>
